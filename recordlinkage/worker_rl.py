...
This script will apply Record Linkage to evaluate privacy risk.
"""
# %%
#!/usr/bin/env python
import functools
...
from apply_rl import modeling_data
...
# Set heartbeat=0 to prevent timeouts on long calculations
...
channel.basic_consume('task_rl', on_message_callback)
